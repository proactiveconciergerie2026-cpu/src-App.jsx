  ...
  return (
    <div className="min-h-screen bg-white text-[#1A4275] selection:bg-[#E8A838]">
      ...
      <div className="bg-[#1A4275] py-20 px-6 text-center text-white">
        <h2 className="text-2xl md:text-4xl font-black mb-8 italic tracking-tighter italic">"Votre tranquillité, notre mission"</h2>
        <div className="flex flex-wrap justify-center gap-8 text-[12px] font-black uppercase tracking-[0.4em] text-[#E8A838]">
          <span className="flex items-center gap-2 underline decoration-1 underline-offset-8">Mohammédia</span>
          <span className="flex items-center gap-2 underline decoration-1 underline-offset-8">Mansouria</span>
          <span className="flex items-center gap-2 underline decoration-1 underline-offset-8">Bouznika</span>
          <span className="flex items-center gap-2 underline decoration-1 underline-offset-8">Benslimane</span>
        </div>
      </div>

      {/* FOOTER - DONNÉES DE L'ENTREPRISE */}
      <footer className="py-16 border-t text-center text-gray-400 text-sm">
        <div className="mb-6">
